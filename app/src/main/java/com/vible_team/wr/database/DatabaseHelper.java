...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1; // old = 1;
    private static final String DATABASE_NAME = "WRTLM4T";

    private static final String TABLE_FOLLOW = "follow";
    private static final String FOLLOW_ID = "follow_id";
    private static final String FOLLOW_POSTER = "follow_poster";
    private static final String FOLLOW_TITLE = "follow_title";
    private static final String FOLLOW_GENRES = "follow_genres";
    private static final String FOLLOW_DATE = "follow_date";
    private static final String FOLLOW_REMIND_DATE = "follow_remind_date";

    private static final String TABLE_WATCHED = "watched";
    private static final String WATCHED_ID = "watched_id";
    private static final String WATCHED_POSTER = "watched_poster";
    private static final String WATCHED_TITLE = "watched_title";
    private static final String WATCHED_GENRES = "watched_genres";

    private static final String TABLE_FAVOURITE = "favourite";
    private static final String FAVOURITE_ID = "favourite_id";
    private static final String FAVOURITE_POSTER = "favourite_poster";
    private static final String FAVOURITE_TITLE = "favourite_title";
    private static final String FAVOURITE_GENRES = "favourite_genres";
